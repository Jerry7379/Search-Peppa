...
if __name__ == '__main__':
    dataset_path = '/home/suger/workspace/pig-face-recognition/data_model/'
    model_path = '/home/suger/workspace/pig-face-recognition/data_model/'
    ...
    imgs = tf.placeholder(tf.float32, [6, 448, 448, 3])
    target = tf.placeholder("float", [None, 30])
    
    resvgg = resvgg(imgs, keep_prob, 'vgg16_weights.npz', sess, finetune = True)   # fine tuning
